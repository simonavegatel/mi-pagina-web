    ...
    <section id="features" className="py-16">
      <Container>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-3xl shadow bg-white text-center border border-primary/20 transition-all duration-500 hover:scale-105 hover:shadow-lg hover:border-accent">
